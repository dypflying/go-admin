...
var cn = LangSet{
	...
	"zone":                               "可用区",
	"cluster":                            "集群",
	"host management":                    "节点管理",
	"registered hosts":                   "已注册节点",
	"physical hosts":                     "物理节点",
	...
	"instance specification":             "实例规格",
	"cluster and instance specification": "集群和实例规格",
	"instance specs with cluster":        "集群和实例规格",
	"volume specification":               "云盘规格",
	"cluster and volume specification":   "集群和云盘规格",
	"volume specs with cluster":          "集群和云盘规格",
	"network":                            "网络",
	"elastic interface":                  "弹性网卡",
	"storage":                            "存储",
	"volume":                             "云硬盘",
	"user images":                        "私有镜像",
	"alert":                              "报警",
	"alert management":                   "报警管理",
	"alert rule":                         "报警规则",
	"snapshot":                           "快照",
	"security group":                     "安全组",
